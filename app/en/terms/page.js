...
export const metadata = {
  ...
  description: "By using Ali W Vide, you agree to use the website responsibly.",
  alternates: {
    canonical: "/en/terms",
    ...
    <SiteShell lang="en">
      <main className="container">
        <section className="hero">
          ...
          <p>By using Ali W Vide, you agree to use the website responsibly.</p>
        </section>
        <article className="card blog-post">
          <p>Ali W Vide provides free online tools for converting and merging files.</p>
